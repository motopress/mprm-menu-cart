<div class="wrap mp-menu-settings">
	<form method="<?php echo esc_attr(apply_filters('mp_menu_settings_form_method_tab_' . urlencode($active_tab), 'post')); ?>" id="mainform" action="options.php" enctype="multipart/form-data">
		...
		ob_start();
		do_settings_sections('mp_menu_settings_' . $active_tab . '_main');
		...
		settings_fields('mp_menu_settings');

		do_settings_sections('mp_menu_settings_' . $active_tab . '_' . $section);
